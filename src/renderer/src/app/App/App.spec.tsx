...
import { registerTestQueryClient } from '@renderer/tests/query-clients'
import {
  createWorkspaceStore,
  type WorkspaceStore,
  type WorkspaceLocation
} from '@renderer/lib/workspace-store'
...
import {
  ...
  type RendererApi
} from '@renderer/tests/mock-api'
import { pretendPlatform } from '@renderer/tests/mock-platform'
