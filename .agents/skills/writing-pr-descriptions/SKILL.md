...
description: >-
  ...
  Not for commit messages (see AGENTS.md, "Git") or user-facing product copy (see `/writing-guidelines`).
---
...
- The subject of a sentence is the change, not its author. Never "I", "me" or "my", and keep "we" for the project.
...
16. Is the `## 🤖 Agent context` section filled, naming the exact model and listing the skills invoked?
