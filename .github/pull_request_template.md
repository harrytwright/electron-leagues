...
- Title: <type>: <Description> — type=feat|fix|chore, under 51 chars, sentence case, no period, no scope. Same rule as the commit subject in AGENTS.md, "Git".
  ✅ feat: Rename leagues from the league menu
  ❌ feat(leagues): added league rename.   (scope, lowercase past tense, period)
